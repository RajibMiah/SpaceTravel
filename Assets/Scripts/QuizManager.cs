...
public class QuizManager : MonoBehaviour
{
    ...
    private CanvasGroup canvasGroup_Quiz;
    ...
    private void Start() {
        ...
        canvasGroup_Quiz = canvas_Quiz.GetComponent<CanvasGroup>(); ;
    ...
    public void ReceiveQuiz(QuestionCollector[] newQuestionList) {
        ...
        /*QuestionList[QuestionList.Length-1].Questions = "";
        QuestionList[QuestionList.Length - 1].A = "";
        QuestionList[QuestionList.Length - 1].B = "";
        QuestionList[QuestionList.Length - 1].C = "";
        QuestionList[QuestionList.Length - 1].D = "";
        QuestionList[QuestionList.Length - 1].correctAns = "";*/
